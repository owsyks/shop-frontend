...
const resources = {
  en: {
    translation: {
      ...
      "contact.networkError": "Network error. Please check your connection.",
  ...
  ar: {
    translation: {
      ...
      "contact.success": "تم إرسال الرسالة بنجاح! سنرد عليك قريباً.",
      "contact.error": "فشل في إرسال الرسالة. حاول مرة أخرى.",
      "contact.networkError": "خطأ في الشبكة. تحقق من اتصالك.",
      ...
      "contact.shippingTime": "كم يستغرق التوصيل؟",
      "contact.shippingAnswer": "معظم الطلبات يتم توصيلها خلال 3-5 أيام عمل.",
      "contact.returnPolicy": "ما هي سياسة الإرجاع؟",
      "contact.returnAnswer": "نوفر إرجاع لمدة 30 يوماً لمعظم المنتجات.",
      "contact.internationalShipping": "هل تقدمون التوصيل الدولي؟",
      "contact.internationalAnswer": "حالياً، نقدم التوصيل داخل الجزائر فقط.",
  ...
  fr: {
    translation: {
      ...
      "contact.networkError": "Erreur réseau. Vérifiez votre connexion.",
      ...
      "contact.shippingAnswer": "La plupart des commandes sont livrées en 3-5 jours ouvrables.",
      ...
      "contact.internationalAnswer": "Actuellement, nous ne livrons qu'en Algérie.",
