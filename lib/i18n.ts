...
const resources = {
  en: {
    translation: {
      ...
      "services.businessCards.price": "Starting from --- DA",
      ...
      "services.customTshirts.price": "Starting from --- DA",
      ...
      "services.customPrinting.price": "Starting from --- DA",
  ...
  ar: {
    translation: {
      ...
      "cart.dzd": "دج",
      "cart.dzdEach": "دج لكل",
      "cart.calculatedAtCheckout": "يتم احتسابها عند الدفع",
      ...
      "services.businessCards.price": "بدءاً من --- دج",
      ...
      "services.customTshirts.price": "بدءاً من --- دج",
      ...
      "services.customPrinting.price": "بدءاً من --- دج",
  ...
  fr: {
    translation: {
      ...
      "cart.calculatedAtCheckout": "Calculé à la caisse",
      ...
      "services.businessCards.price": "À partir de --- DA",
      ...
      "services.customTshirts.price": "À partir de --- DA",
      ...
      "services.customPrinting.price": "À partir de --- DA",
