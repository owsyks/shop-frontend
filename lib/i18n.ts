...
const resources = {
  ...
  ar: {
    translation: {
      ...
      "features.shipping.desc": "معظم الطلبات يتم تسليمها خلال 1-3 أيام عمل",
      ...
      "cart.itemsInCart": "العناصر في سلتك",
      "cart.item": "عنصر",
      "cart.items": "عناصر",
      "cart.clearAll": "مسح الكل",
      "cart.clearing": "جاري المسح...",
      ...
      "cart.fastDelivery": "توصيل سريع خلال 2-3 أيام عمل",
      "cart.returnPolicy": "سياسة إرجاع لمدة 30 يوم",
      "cart.securePayment": "معالجة دفع آمنة",
  ...
  fr: {
    translation: {
      ...
      "cart.fastDelivery": "Livraison rapide en 2-3 jours ouvrables",
      "cart.returnPolicy": "Politique de retour de 30 jours",
      ...
      "services.customPrinting.description": "Solutions d'impression complètes pour dépliants, brochures, bannières et plus. Qualité professionnelle pour tous vos besoins marketing.",
      "services.customPrinting.features.variety": "Grande variété de matériaux",
      ...
      "services.whyChooseUs.quality.description": "Nous utilisons uniquement les meilleurs matériaux et les dernières technologies d'impression pour garantir des résultats exceptionnels",
      ...
      "services.whyChooseUs.experience.title": "Équipe d'Experts",
